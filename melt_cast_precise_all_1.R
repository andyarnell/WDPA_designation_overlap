...
reshapedTypeAll$xy<-paste0(round(reshapedTypeAll$INSIDE_X,1),"_",round(reshapedTypeAll$INSIDE_Y,1))
...
write.csv(reshapedTypeAll,fileTypeAll,na="0",row.names=FALSE)
...
fileTypeAllSR<-"reshapedTypeAllSR.csv"
...
names(reshapedTypeAllSR)
names(reshapedTypeAllSR_AGG)<-c(names(reshapedTypeAllSR[c(2,3)]), names(reshapedTypeAllSR[7:12]),names(reshapedTypeAllSR[15]),names(reshapedTypeAllSR[6]))
