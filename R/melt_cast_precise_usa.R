...
setwd(in.folder)
getwd()
dataset<-read.csv("merged_aggsr_admin_USA.csv")#header=TRUE,sep=",")
head(dataset)
tmp<-dataset
...
reshapedTypeAll[,7:(length(names(reshapedTypeAll))-1)]
reshapedTypeAll$countSum <- rowSums(reshapedTypeAll[,7:(length(names(reshapedTypeAll))-1)])
reshapedTypeAll$xy<-paste0(reshapedTypeAll$INSIDE_X,"_",reshapedTypeAll$INSIDE_Y)
...
fileTypeAllSR<-"reshapedTypeAll_USA.csv"
head(reshapedTypeAllSR)

write.csv(reshapedTypeAllSR,fileTypeAllSR,na="0",row.names=FALSE)
names(reshapedTypeAllSR[6:12])
names(reshapedTypeAllSR[c(2,3,6)])
...
#subset(reshapedTypeAllSR,reshapedTypeAllSR$ISO3=="CHN")
...
names(reshapedTypeAllSR)
names(reshapedTypeAllSR_AGG)<-c(names(reshapedTypeAllSR[c(2,3)]), names(reshapedTypeAllSR[7:12]),names(reshapedTypeAllSR[14]),names(reshapedTypeAllSR[6]) )
head(reshapedTypeAllSR_AGG)

fileTypeAllSR_AGG<-"reshapedTypeAllSR_AGG.csv"
...
# mytable<-table(reshapedTypeAllSR$"National",reshapedTypeAllSR$"Ramsar Site, Wetland of International Importance",                  
#       reshapedTypeAllSR$"Site of Community Importance (Habitats Directive)",reshapedTypeAllSR$"Special Protection Area (Birds Directive)", reshapedTypeAllSR$"UNESCO-MAB Biosphere Reserve",reshapedTypeAllSR$"World Heritage Site"
#       ,reshapedTypeAllSR$other_regional,reshapedTypeAllSR$"National",reshapedTypeAllSR$"Ramsar Site, Wetland of International Importance",                  
#       reshapedTypeAllSR$"Site of Community Importance (Habitats Directive)",reshapedTypeAllSR$"Special Protection Area (Birds Directive)", reshapedTypeAllSR$"UNESCO-MAB Biosphere Reserve",reshapedTypeAllSR$"World Heritage Site"
