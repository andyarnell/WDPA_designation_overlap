...
filenames
filenames<-filenames[lapply(filenames,function(x) length(grep("int_",x,value=FALSE))) == 1]
filenames<-filenames[lapply(filenames,function(x) length(grep("Admin",x,value=FALSE))) == 1]
...
fc_list<-fc_list[lapply(fc_list,function(x) length(grep("Uniq",x,value=FALSE))) == 1]
fc_list<-fc_list[lapply(fc_list,function(x) length(grep("Admin",x,value=FALSE))) == 1]
...
#   filenamesEdt<-filenamesEdt[4]
  filenamesEdt<-gsub("_preciseAdminIntUnionFC","_preciseAdminIntUnionUniqFC", filenamesEdt)
  filenamesEdt<-gsub("int_","", filenamesEdt)
  print (filenamesEdt)
